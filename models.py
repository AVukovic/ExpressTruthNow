...
class Media(Model):
    ...
    def parse(cls, api, json):
        ...
        for k, v in json.items():
            ...
            def f(self):
                return media
                #this will hopefully allow the Media class to be treated as an object and used in utility in order to filter out entities in tweepy
                #ok, it seemed to work but at this point is where I ran into a key error. Likely something with the directory
